...
include('connection.php');
    ...
    if(isset($_POST['filter_submit'])){
        ...
        $crypto_type = mysqli_real_escape_string($link, $_POST['crypto_type']);
        
        $start_date = "$from_day-$from_month-$from_year";
        $end_date = "$to_day-$to_month-$to_year";

            $_SESSION['history_type'] = "";
            $_SESSION['history_start_date'] = "";
            $_SESSION['history_end_date']   = "";
            $_SESSION['crypto_type']   = "";
        
          $_SESSION['history_type'] = $history__type;
          $_SESSION['history_start_date'] = $start_date;
          $_SESSION['history_end_date']   = $end_date;
          $_SESSION['crypto_type']   = $crypto_type;
        
       echo "<script>
        function navigate(){
        window.location = './?a=history';
        }
