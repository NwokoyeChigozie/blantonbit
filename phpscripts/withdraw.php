...
if(isset($_POST['withdrawal_submit'])){ 
    ...
    $withdraw_currency = mysqli_real_escape_string($link, $_POST['withdraw_currency']);
...
//            $withdrawal_date = date("M-d-Y h:i:s A", time());
            $withdrawal_date = date("d-m-Y", time());
                $sql= "INSERT INTO `withdrawal`(`u_id`,`type`,`username`, `currency`,`withdrawal_amount`, `btc_address`,`date`,`ip`,`crypto_currency`, `status`) VALUES ('$u_id','$plan','$user_name','$','$withdraw_amount','$withdraw_bitcoin_address','$withdrawal_date','$ip','$withdraw_currency','pending')";

    
        if(mysqli_query($link, $sql)){
            $last_id = $link->insert_id;
//            $withdrawal_date = date("d-m-Y h:i:s A", time());
                $sql= "INSERT INTO `history`(`u_id`,`username`, `type`,`amount`, `date`,`crypto_currency`,`status`,`tid`) VALUES ('$u_id','$user_name','$purpose','$withdraw_amount','$withdrawal_date','$withdraw_currency','pending','$last_id')";
