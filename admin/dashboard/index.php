        ...
        <div class="col-md-12">
          <div class="card card-secondary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="inputEstimatedBudget">Company's Location</label>
                <input type="text" name="company_location" class="form-control" value="<?php echo $company_location; ?>">
              </div>
            </div>
...
<?php
 if($_POST){
     if(isset($_POST['data_update'])){
         ...
         $company_location= $_POST['company_location']; $company_location = mysqli_real_escape_string($link, $company_location);
     
     
 $sql = "UPDATE `admin` SET `support_email` = '$support_email',`support_phone` = '$support_phone',`company_location` = '$company_location' WHERE `id` = 1";   
