...
$crypto_currency = $payment_row['to_currency']; //BTC
...
if(time() - $reg_stamp < 86400){
    ...
    $sql_t = "UPDATE `payments` SET `status`='completed' WHERE `id`= '$p_id'";    
                ...
                if(mysqli_query($link, $sql)){
                    ...
                    $sql= "INSERT INTO `history`(`u_id`,`username`, `type`,`amount`, `date`, `crypto_currency`,`status`,`tid`) VALUES ('$u_id','$username','Deposit','$history_amount','$w_date','$crypto_currency','completed','$p_id')";
                    if(mysqli_query($link, $sql)){
